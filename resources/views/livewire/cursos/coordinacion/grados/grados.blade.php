                            ...
                            <div class="bg-moradoClaro-200">
                                ...
                                <div class="flex justify-between items-center gap-x-4 p-2 ">
                                    ...
                                    <div class="flex flex-col gap-y-2 w-2/5">
                                        ...
                                        <button type="button" class="button-secondary-cursos p-1 rounded-lg"
                                            wire:click="$dispatch('openModal', { component: 'cursos.coordinacion.materias.materias-registro', arguments: { idGrado: {{ $grado->id }}, formAction: 'asignar' } })"
                                            class="button-normal">
                                            Asignar
                                        </button>
                                    </div>
