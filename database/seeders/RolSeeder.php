...
class RolSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Rol::factory()->count(10)->sequence(
            ...
            ['tipo_id' => 2, 'nombre' => 'Alumno cursos licenciatura', 'nombre_url' => 'alumno.cursos.licenciatura', 'estatus' => 1,],
            ...
            ['tipo_id' => 6, 'nombre' => 'Coordinación de cursos', 'nombre_url' => 'coordinacion.cursos', 'estatus' => 1,],
